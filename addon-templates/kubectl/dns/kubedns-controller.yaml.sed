...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
      - name: kubedns
        image: $DOCKER_IO_REGISTRY/steady1211/k8s-dns-kube-dns-amd64:1.14.2
        resources:
      ...
      - name: dnsmasq
        image: $DOCKER_IO_REGISTRY/steady1211/k8s-dns-dnsmasq-nanny-amd64:1.14.2
        livenessProbe:
          httpGet:
      ...
      - name: sidecar
        image: $DOCKER_IO_REGISTRY/steady1211/k8s-dns-sidecar-amd64:1.14.2
        livenessProbe:
          httpGet:
            path: /metrics
            port: 10054
